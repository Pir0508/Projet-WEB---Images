        ...
        <div class="col-md-8 col-md-offset-2"  style="margin-top:5em;">
            <form action="<?php echo e(route('image.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="title"><?php echo e(__('message.titleImg')); ?></label>
                ...
                <div class="form-group">
                  <label for="public"><?php echo e(__('message.public')); ?></label>
                  <ul class="tg-list">
                    <li class="tg-list-item">
                      <input type="checkbox" id="cb3" class="tgl tgl-skewed form-control" name="public"/>
                      <label class="tgl-btn" data-tg-off="<?php echo e(__('message.no')); ?>" data-tg-on="<?php echo e(__('message.yes')); ?>", for="cb3" />
                    </li>
                  </ul>
                  </label>
